...
export interface LlmCombinedEvaluation { llm: LlmBasicInfo; scores: EvaluationData['scores']; score_distributions?: EvaluationData['score_distributions']; additional_info_comments?: EvaluationData['additional_info_comments']; totalScore: number | null; }
